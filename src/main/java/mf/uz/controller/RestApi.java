...
//  Find all users
    @RequestMapping(value = "/api/get/users", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
...
//  Find one user
    @RequestMapping(value = "/api/get/users/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Users> getUser(@PathVariable Long id) {
        return new ResponseEntity<>(usersService.findOne(id), HttpStatus.OK);
    }
//  Save user
    @RequestMapping(value = "/api/post/users", method = RequestMethod.POST)
    public Users setUsers(@RequestBody Users users) {
        return usersService.save(users);
    }
//  Edit user
    @RequestMapping(value = "/api/post/users/{id}", method = RequestMethod.PUT)
...
//  Find all departments
    @RequestMapping(value = "/api/get/departments", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
...
//  Find one department
    @RequestMapping(value = "/api/get/departments/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Department> getDepartment(@PathVariable Long id) {
        return new ResponseEntity<>(departmentService.findOne(id), HttpStatus.OK); 
    }

//  Save department
    @RequestMapping(value = "/api/post/departments", method = RequestMethod.POST)
    public Department setDepartments(@RequestBody Department department) {
        return departmentService.save(department);
    }
//  Edit department
    @RequestMapping(value = "/api/post/departments/{id}", method = RequestMethod.PUT)
    public Department editDepartment(@RequestBody Department department) {
        return departmentService.save(department);
    }
//  Remove department
    @RequestMapping(value = "/api/get/departments/{id}", method = RequestMethod.DELETE)
    @ResponseBody
...
//  Find all modules
    @RequestMapping(value = "/api/get/modules", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Collection<Module>> getModules() {
        Collection<Module> modules = moduleService.findAll();
        return new ResponseEntity<>(modules, HttpStatus.OK);
    } 
//  Find one module
    @RequestMapping(value = "/api/get/modules/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
...
//  Save module
    @RequestMapping(value = "/api/post/modules", method = RequestMethod.POST)
    public Module setModule(@RequestBody Module module) {
        return moduleService.save(module);
    }
//  Edit module
    @RequestMapping(value = "/api/post/modules/{id}", method = RequestMethod.PUT)
...
//    Role JSON
    @RequestMapping(value = "/api/get/roles", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
